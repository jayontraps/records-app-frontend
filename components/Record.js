...
class Record extends Component {
  ...
  render(props) {
    ...
    const {
      id,
      species: { name },
      location: { site, gridRef },
      status,
      author: { name: authorrName },
      legacyObserver,
      count,
      date,
      startTime,
      ...
      <StyledRecord className={`record ${collapsedStatus}`}>
        <div className="record-data" onClick={e => this.openPanel(e)}>
          <div className="row first">
            ...
            <div
              className={`cell observer ${
                authorrName === 'Legacy' ? 'legacy-observer' : ''
              }`}
            >
          ...
          <div className="expandpanel__content">
            <div className="row second">
              ...
              <div className="cell breeding_code">
                Breeding code: {breeding_code ? breeding_code.code : ''}
              </div>
        ...
        <div className="record-options">
          <div onClick={e => this.openPanel(e)} className="cell view-more">
            <Icon className="more__icon" name="down-arow" />
          </div>
          ...
          <div className="cell crud-options">
            ...
            >
              <Icon className="more__icon" name="more_vert" />
            </div>
